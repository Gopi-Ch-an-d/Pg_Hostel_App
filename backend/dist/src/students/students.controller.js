...
let StudentsController = class StudentsController {
    ...
    create(dto) { return this.studentsService.create(dto); }
    findAll(query) { return this.studentsService.findAll(query); }
    getAvailableRooms() { return this.studentsService.getAvailableRooms(); }
    getMinimal() { return this.studentsService.getMinimal(); }
    findOne(id) { return this.studentsService.findOne(id); }
    update(id, dto) {
        return this.studentsService.update(id, dto);
    }
    remove(id) { return this.studentsService.remove(id); }
    uploadId(id, file) {
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], StudentsController.prototype, "getAvailableRooms", null);
__decorate([
    (0, common_1.Get)('minimal'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], StudentsController.prototype, "getMinimal", null);
__decorate([
    (0, common_1.Get)(':id'),
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], StudentsController.prototype, "uploadId", null);
