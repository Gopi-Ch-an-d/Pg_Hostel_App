...
let ComplaintsController = class ComplaintsController {
    ...
    create(dto) { return this.complaintsService.create(dto); }
    findAll(query) { return this.complaintsService.findAll(query); }
    getStats() { return this.complaintsService.getStats(); }
    update(id, dto) { return this.complaintsService.update(id, dto); }
};
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, create_complaint_dto_1.UpdateComplaintDto]),
    __metadata("design:returntype", void 0)
