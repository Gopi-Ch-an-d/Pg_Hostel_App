...
exports.ComplaintsModule = ComplaintsModule = __decorate([
    (0, common_1.Module)({ controllers: [complaints_controller_1.ComplaintsController], providers: [complaints_service_1.ComplaintsService], exports: [complaints_service_1.ComplaintsService] })
], ComplaintsModule);
